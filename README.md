...
It shows one idea in plain language: when software acts on behalf of people,
the action should leave a readable trace.

## What is this?

A small field notebook around **Agent Decision Receipts**.
Each receipt records intent, permission, evidence, refusal or approval, and closeout.

## Why does it matter?

A software agent that only talks is useful.
A software agent that acts creates an authority problem.
